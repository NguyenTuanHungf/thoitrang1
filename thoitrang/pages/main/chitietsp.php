...
?>
	<div>
					<div id="product">
						<div id="backtoshop">
							<a href="./index.php">< back to new arrivals</a>
						</div>
					</div>
...
<p id="soluong-label">Số lượng: </p>
    <input type="number" id="soluong" name="soluong" min="1" max="1" disabled oninput="updateQuantityLabel(this.value)">
									...
									<div class="detail-right-info-price">
										...
										<p>    
                                            <?php if($row_sanpham['km']>0){ echo '<span id="discount-price">-' . $row_sanpham['km'] . '%</span>';
                                          echo number_format($giaspkm).'đ'; }else {echo  number_format($row_sanpham['giasp']).'đ';} ?>
                                            <span class="pro-price-del">
                                           <?php if($row_sanpham['km']>0){
                                                    echo '<span class="original-price">' . number_format($row_sanpham['giasp']).'đ';
                                                    }else{
...
<div class="delivery-info">
        ...
        <div class="delivery-info-item">
            ...
            <span class="phuonganhheader">Freeship toàn quốc từ 399k<br>Miễn phí vận chuyển<br>Đơn hàng từ 399K</span>
        </div>
        <div class="delivery-info-item">
        ...
        <div class="delivery-info-item">
            ...
            <span class="phuonganhheader">Thanh toán dễ dàng<br>Nhiều hình thức<br>Hotline hỗ trợ 039 9999 365</span>
        </div>
    </div>
    </div>
									...
									<div class="product-description">
										<div class="description-content">
											<div class="description-productdetail">
												...
												<p class="phuonganhheader"><?php echo $row_sanpham['tomtat'] ?></p>
												<hr>
                                ...
                                ?>
                                    ...
                                    <div class="maincontent-item">
                                        ...
                                        <div class="maincontent-info">
                                            ...
                                            <a href="index.php?quanly=chitiet&idsanpham=<?php echo $row_pro['id_sanpham'] ?>" class="maincontent-gia"><?php if($row_pro['km']>0){ echo number_format($giaspkm).'đ'; }else {echo number_format($row_pro['giasp']).'đ';} ?>
                                            <span class="pro-price-del">
                                    <?php
                                    if ($row_pro['km'] > 0) {
