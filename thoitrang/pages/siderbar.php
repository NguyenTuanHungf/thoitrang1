...
<div class="toggle-sidebar-btn" onclick="toggleSidebar()">
   <span class="open-icon">&#9776;</span>
    ...
    <a href="./index.php" class="header-slb"><img style="margin-top:20px;
" src="./assets/img/logocaro.png" alt="logo" height="auto" width="60%"></a>
    <ul>
        ...
        <li><a href="index.php?quanly=donhang"><i class="bi bi-bag"></i>ORDER</a></li>
        <?php 
