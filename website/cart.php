            ...
            <div class="box" style="padding: 0 40px">
                ...
                <?php } else { ?>
                        ...
                        <tr>
                            ...
                            <form action="./functions/ordercode.php" method="post">
                                <td width=100>
                                    ...
                                    <input type="hidden" class="product-price" value="<?= number_format($product['selling_price']) ?>">
                                ...
                                <td>
                                    ...
                                    <span class="total-price">
                                        <?= number_format($product['selling_price'] * $product['quantity']) ?>
                                    </span>
                                </td>
                                <td>
                    ...
                    <!-- <form action="./functions/ordercode.php" method="post">
                        ...
                        <p style="display: block;">Tổng tiền: ₫   <?=number_format($total_price)?></p>
                ...
                <br>
                <a href="./pay.php" class="buttonpay">
