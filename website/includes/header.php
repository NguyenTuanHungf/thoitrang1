        ...
        <div class="header-wrapper" id="header-wrapper">
            ...
            <div class="bg-second">
                <div class="top-header container">
                    <ul class="devided" style="margin-top:20px;">
                        <li>
                            <a href="#">Hotline mua hàng : 0386767417</a>
                        </li>
                        <li>
                            <a href="#">(8:30-21:30, Tất cả các ngày trong tuần)</a>
                        </li>
                    </ul>                    
                </div>
            </div>
            ...
            <div class="bg-main">
                <div class="mid-header container">
                    <a href="index.php" class="logo">CARO</a>
            ...
            <div class="bg-second">
                <div class="bottom-header container">
                    <ul class="main-menu">
                        ...
                        <!-- mega menu -->
                        <li class="mega-dropdown">
                            <a href="index.php">Category<i class='bx bxs-chevron-down'></i></a>
                            <div class="mega-content">
                                <div class="row">                                  
                                    <div class="col-md-12">
                                        <div class="box">
